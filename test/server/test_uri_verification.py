...
from src.server.main import validate_uri
...
class UriVerificationTest(unittest.TestCase):
    ...
    def test_valid_songs(self):
        ...
        valid_uris = ["spotify:track:5YZuePCawcrg0DJrWovPu7", "spotify:track:3Ofmpyhv5UAQ70mENzB277", "spotify:track:0qcr5FMsEO85NAQjrlDRKo",
    ...
    def test_bad_format_uris(self):
        ...
        bad_format_uris = ["", "spootify:track:5YZuePCawcrg0DJrWovPu7",
    ...
    def test_invalid_song_uris(self):
        ...
        invalid_uris = ["spotify:track:4YZuePCawcrg0DJrWovPu7", "spotify:track:1IHWl5LamUGEuP4ozKQSXY", "spotify:track:2Ofmpyhv5UAQ70mENzB277"]
